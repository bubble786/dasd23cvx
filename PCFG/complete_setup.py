...
from buildPCFG import parallel_buildpcfg
...
def create_pcfg(vault_leak, password_leak=None):
    ...
    # build pcfg according to password leak
...
def main():
    if len(sys.argv)<2 or sys.argv[1] == '-help':
        """This script will (should) generate all the static required files
