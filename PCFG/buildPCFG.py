...
def buildpcfg(passwd_dictionary, start=0, end=-1, outf=hny_config.TRAINED_GRAMMAR_FILE):
    # MIN_COUNT=1000
    R = RuleSet()
    # resource track
    resource_tracker = 10**9 #5240
    for n, line in tqdm(enumerate(open_(passwd_dictionary, 'r'))):
        try:
