...
def clean_pwdata():
    with open(SOURCE_PATH + '/data/neopets-plain.txt', 'r') as file:
    ...
    # write
    '''with open(SOURCE_PATH + '/data/neopets-flat.txt', 'w') as f:
...
def process_raw_neopets():
    ...
    with open(SOURCE_PATH + '/data/neopets-plain.txt', 'w') as f:
        for pw in passwords:
            f.write('%s\n' % pw)
        print("File written successfully")
...
def count_pws():
    with open(SOURCE_PATH + '/data/neopets-flat.txt', 'r') as file:
        lines = [line.rstrip() for line in file]
    ...
    with open(SOURCE_PATH + '/data/neopets-withcount', 'wb') as fb:
...
if __name__ == '__main__':
    ...
    length_dict = {}
    with open(SOURCE_PATH + '/data/neopets-withcount', "rb") as f:
