...
def find_clusters(pws_, progress):
    ...
    for pw in pws:
        ...
        for i, group in enumerate(groups):
            for pw_trg in list(set(group)): #  group
...
def dir2file():
    write_dir = "/home/dataset/BreachCompilation/emailpws_files/"
    data_dir = "/home/dataset/BreachCompilation/data"
    cnt = 0
...
def file2groups_emailbased():
    read_dir = "/home/dataset/BreachCompilation/emailpws_files/"
    write_dir = "/home/dataset/BreachCompilation/emailbased_groups/"
...
def email2usernamebased_or_mixed():
    read_dir = "/home/dataset/BreachCompilation/emailbased_groups/"
    write_dir = "/home/dataset/BreachCompilation/mixed_groups/"
...
def analysis_vaults():
    read_dir = "/home/dataset/BreachCompilation/mixed_groups_g2_distinct/"
    paths = glob(read_dir + '*.pkl')
    workers = []
    ...
    np.savetxt("/home/dataset/BreachCompilation/mixed_groups.csv", results, delimiter=",")


def duplicate_check():
    read_dir = "/home/dataset/BreachCompilation/mixed_groups_g2/"
    write_dir = "/home/dataset/BreachCompilation/mixed_groups_g2_distinct/"
    paths = glob(read_dir + '*.pkl')
    workers = []
    duplicate_num = 0
    pool = Pool(10)
...
def turn2testset():
    read_dir = "/home/dataset/BreachCompilation/mixed_groups_51_200/"
    write_dir = "/home/dataset/BreachCompilation/mixed_groups_51_200_g184/"
    paths = glob(read_dir + '*.pkl')
    testset_size = 0
    vault_total  = 0
    workers = []
...
def testset_statistics():
    read_path = '/home/dataset/BreachCompilation/mixed_groups_2_200_tr.json'#"/home/dataset/BreachCompilation/processed_dataset/Dbc_ts.pkl"
    ...
    for w in workers:
        stat.append(w.get())
    # write to file
    write_path = "/home/dataset/BreachCompilation/bc_ts_stat.pkl"
    with open(write_path, 'wb') as f:
        pickle.dump(stat, f)

def keepvaultsize():
    with open("/home/dataset/BreachCompilation/bc_testset.pkl", 'rb') as f:
        vaultdict = pickle.load(f)
    itms = list(vaultdict.items())
    for k, v in itms:
        if len(v) <= 50 or len(v) > 200 or len(set(v)) == 1:
            del vaultdict[k]
    with open("/home/dataset/BreachCompilation/bc_testset_g50.pkl", 'wb') as f:
...
def split_highlow_reuse():
    pool = Pool(30)
    workers = []
    with open("/home/dataset/BreachCompilation/bc_testset_g50.pkl", 'rb') as f:
        vaultdict = pickle.load(f)
    ...
    for w in workers:
        ...
        if flag == 0:
            ...
            lowreuse[k] = v
    with open("/home/dataset/BreachCompilation/bc_testset_g50_highreuse.pkl", 'wb') as f:
        pickle.dump(highreuse, f)
    with open("/home/dataset/BreachCompilation/bc_testset_g50_lowreuse.pkl", 'wb') as f:
...
def main():
    ...
    keepvaultsize()
    split_highlow_reuse()
    split2train_test('/home/dataset/BreachCompilation/mixed_groups_51_200.json')
    pkls2json_51_200(readdir='/home/dataset/BreachCompilation/mixed_groups_51_200_g184', writepath='/home/dataset/BreachCompilation/mixed_groups_51_200.json')
    pkls2json_2_50(readdir='/home/dataset/BreachCompilation/mixed_groups_2_50_g184', writepath='/home/dataset/BreachCompilation/mixed_groups_2_50_final')


if __name__ == '__main__':
    #main()
    #pickles2dict('/home/dataset/BreachCompilation/mixed_groups_2_50_final_train', '/home/dataset/BreachCompilation/mixed_groups_2_50_tr.json', id_offset=91566159)

    '''vaultdict = {}
    with open("/home/dataset/BreachCompilation/mixed_groups_2_200_tr.json", 'rb') as f:
