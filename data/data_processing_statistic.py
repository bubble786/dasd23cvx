...
def email2usernamebased_or_mixed():
    ...
    while len(paths) > 0:
        ...
        if len(workers) == 5 or len(paths) == 0:
            ...
            workers = []
    # write stat to csv
    with open("/home/dataset/BreachCompilation/mixed_groups_stat.csv", 'w') as f:
        writer = csv.writer(f)
...
def analysis_vaults():
    read_dir = "/home/dataset/BreachCompilation/usernamebased_groups/"
    paths = glob(read_dir + '*.pkl')
    workers = []
    stat = np.zeros(3)
    pool = Pool(8)
...
def turn2testset():
    read_dir = "/home/dataset/BreachCompilation/mixed_groups_g9/"
    write_dir = "/home/dataset/BreachCompilation/mixed_groups_2to50/"
    paths = glob(read_dir + '*.pkl')
    testset_size = 0
    vault_total  = 0
    workers = []
...
def testset_statistics():
    read_path = '/home/incremental_vault_gpu/data/breachcompilation/fold2/fold_0_2.json'#"/home/dataset/BreachCompilation/processed_dataset/Dbc_ts.pkl"
    ...
    for w in workers:
        stat.append(w.get())
    # write to file
    write_path = "/home/dataset/BreachCompilation/bc_testset_stat.pkl"
...
def split2train_test():
    ...
    # write to json file
    with open("/home/dataset/BreachCompilation/Dbc_tr.json", 'w') as f:
        json.dump(traindict, f)
    with open("/home/dataset/BreachCompilation/Dbc_ts.json", 'w') as f:
...
def main():
    ...
    #split_highlow_reuse()
    #split2train_test()
    #pkls2json(readdir='/home/dataset/BreachCompilation/mixed_groups_2to50', writepath='/home/dataset/BreachCompilation/mixed_groups_2to50.json')
...
if __name__ == '__main__':
    ...
    '''with open('/home/dataset/BreachCompilation/fold_0_1.json', 'r') as f:
        vaultdict = json.load(f)
    with open('/home/incremental_vault_gpu/data/breachcompilation/fold2/fold_0_2.json', 'r') as f:
        vaultdict.update(json.load(f))'''
    '''vaultdict = {}
    for i in range(1, 6):
        with open("/home/incremental_vault_gpu/data/pastebin/fold5_Nge5/fold_" + str(i) + ".json", 'r') as f:
            vaultdict.update(json.load(f))
