...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--exp_pastebinsuffix', type=str, default='_bc50')
        ...
        # newly added by zzp
        self.parser.add_argument('--tag', type=str, default='default', help='tag for the experiment')
        self.parser.add_argument('--dtimes', type=int, default=2, help='the times of d/r in sgf construct like 8, 16, 32, 64, ...')
        self.parser.add_argument('--repeat_times', type=int, default=2, help='the number of attack repeat times')
