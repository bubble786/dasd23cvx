...
# read_path = '/home/dataset/BreachCompilation/mixed_groups_2_200_ts.json'
# with open(read_path, "rb") as f:
#     vaultdict = orjson.loads(f.read())
# items_ = list(vaultdict.items())
# toselect_size = dict()

# vaultsizelist = [len(v) for v in list(vaultdict.values())]
# sizedistribution = [[i, vaultsizelist.count(i)] for i in range(2,201)]
...
#         break
# write_path = '/home/dataset/BreachCompilation/mixed_groups_2_200_minits.json'
...
# # write back to file
# with open(SOURCE_PATH + '/attack/results/MSPM/bc200/100vaults/fold_0_1.json', 'r') as f: #'/hdd1/bubble_experiments/results/MSPM/bc100/vaults_cmr_pl8/fold_0_1.json'
#    vaults = json.load(f)
...
ranks = np.genfromtxt(SOURCE_PATH + '/attack/results_handling/table_data/rank.csv', delimiter=',')
...
fps = np.genfromtxt(SOURCE_PATH + '/attack/results_handling/table_data/Fp.csv', delimiter=',')
