...
def fit_unreuse_p():
    ...
    vaults = {}
    vaultpaths = [SOURCE_PATH+'/dataset/BreachCompilation/mixed_groups_2_50_tr.json']#, '/dataset/BreachCompilation/mixed_groups_51_200_tr.json' glob('/data/pastebin/fold5/*') #
