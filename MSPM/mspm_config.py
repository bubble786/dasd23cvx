SOURCE_PATH = '/home/zzp/lab/bubble/bubble-v2/Bubble-fixed2/'
...
if args.exp_pastebinsuffix == '_pb':
    PASTB_PATH = SOURCE_PATH +'/data/pastebin/fold2' #'/data/pastebin/fold2' # /data/breachcompilation/fold2
elif args.exp_pastebinsuffix == '_bc50' or args.exp_pastebinsuffix == '_bc100' or args.exp_pastebinsuffix == '_bc200':
    PASTB_PATH = SOURCE_PATH +'/data/breachcompilation/fold2' #/data/breachcompilation/fold2

ALPHA = 0.4 #_bc;0.5710 #_pb;

T_PHY = N_EXP_VAULTS = REFRESH_RATE = PS_DECOYSIZE = 1000 #set T ,the same as following PS_DECOYSIZE

PIN_SAMPLE = int(10**4) # 10^x for x-pin,指令也要改--pin RockYou-4-digit.txt --pinlength 4
Nitv = 10 # fixed-interval shuffling
###
...
PROCESS_NUM = 1 # 16 multi-thread 1 single-thread
REPEAT_NUM = 20
TEST_DATA_ID = 0
...
SCALE_PROCESSOR = 1
MAX_PW_NUM = 210 # MSPM pw cnt max
SCALAR = 2**20
...
PRE_DECOYS = '/home/zzp/lab/bubble/bubble-v2/Bubble-fixed2/attack/decoydict/MSPM/dict1000_100_15.data'
